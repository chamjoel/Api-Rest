...
//Divido l'url andando a capo per questioni di leggibilità non perchè sia necessario
    this.obsCiVett = this.http.get<Ci_vettore[]>(`https://3000-b6bba854-efb4-4878-962a-3c59a1633832.ws-eu01.gitpod.io/ci_geovettore/
    ${this.circleLat}/
    ${this.circleLng}/
    ${raggioInGradi}`);
  ...
  ngOnInit() {
    this.obsGeoData = this.http.get<GeoFeatureCollection>("https://3000-b6bba854-efb4-4878-962a-3c59a1633832.ws-eu01.gitpod.io/");
    ...
    cambiaFoglio(foglio) : boolean
  {
    ...
    this.obsCiVett = this.http.get<Ci_vettore[]>(`https://3000-b6bba854-efb4-4878-962a-3c59a1633832.ws-eu01.gitpod.io/ci_vettore/${val}`);  //Realizza delle richieste di tipo get ci_vettore al server
