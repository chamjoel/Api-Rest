...
export class AppComponent implements OnInit {
  ...
  serverUrl : string = "https://3000-c8382e52-0012-4b2a-8fd6-409a7e7980fb.ws-eu01.gitpod.io";
  ...
  cambiaFoglio(foglio) : boolean
  {
    ...
    this.obsCiVett = this.http.get<Ci_vettore[]>(`https://3000-c8382e52-0012-4b2a-8fd6-409a7e7980fb.ws-eu01.gitpod.io/ci_vettore/${val}`);  //Fa una get per ricavare dati da una pagina specifiacata
  ...
  all() : boolean
  {
    this.img="https://media1.tenor.com/images/0f837fcbffca4ba481f07df2abd7b73f/tenor.gif?itemid=8821491";
    this.allData = this.http.get<GeoFeatureCollection>(`https://3000-c8382e52-0012-4b2a-8fd6-409a7e7980fb.ws-eu01.gitpod.io/all`);
